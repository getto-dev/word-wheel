    ...
    >
      <div className="flex h-full w-full flex-col overflow-hidden relative">
        ...
        <img
          ...
          alt="Иконка информации"
        />
        <button aria-label="закрыть диалог" onClick={() => dismissInfoDialog()} className="absolute top-4 right-4 w-[44px] h-[44] text-black flex flex-col justify-center items-center">
